...
def init_telescope_config_dict(use_default_values = True) : 
	...
	if use_default_values:
		...
		tel_config_dict['pup_geometry'] = 'AT' # 'disk', 'AT', or 'UT'
		...
		tel_config_dict['pup_geometry'] = pup_geometry # 'disk', 'AT', or 'UT'
...
def init_calibration_source_config_dict():

	if use_default_values:
		calibration_source_config_dict['type'] = 'calibration_source'
		calibration_source_config_dict['spectral_type'] = cal_source_type # flat or blackbody
		...
		calibration_source_config_dict['detector'] = init_detector_config_dict(use_default_values=True) # init detector config to use on
		...
		calibration_source_config_dict['detector'] = init_detector_config_dict(use_default_values=False)
